    ...
    while not finished:
        ...
        if len(task.yields) > 0:
            ...
            if flag == 'finish':
                ...
                # delete Proto temp images, only keep gradio temp images
...
title = f'Proto {proto_version.version}'
            ...
            with gr.Row(visible=False) as image_input_panel:
                with gr.Tabs():
                    ...
                    with gr.TabItem(label='Metadata') as metadata_tab:
                        with gr.Column():
                            metadata_input_image = grh.Image(label='For images created by Proto', source='upload', type='pil')
                        ...
                        with gr.TabItem(label=f'#{index + 1}') as enhance_tab_item:
                            ...
                            with gr.Accordion("Inpaint", visible=True, open=False):
                                ...
                                enhance_inpaint_engine = gr.Dropdown(label='Inpaint Engine',
                                                                     ...
                                                                     info='Version of Proto inpaint model. If set, use performance Quality or Speed (no performance LoRAs) for best results.')
                ...
                with gr.Column(visible=False) as dev_tools:
                    with gr.Tab(label='Debug Tools'):
                        ...
                        adaptive_cfg = gr.Slider(label='CFG Mimicking from TSNR', minimum=1.0, maximum=30.0, step=0.01,
                                                 ...
                                                 info='Enabling Proto\'s implementation of CFG mimicking for TSNR '
