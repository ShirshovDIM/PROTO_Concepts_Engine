...
def try_load_deprecated_user_path_config():
    ...
    try:
        ...
        replace_config('proto_expansion_path', 'path_proto_expansion')
...
path_proto_expansion = get_dir_or_set_default('path_proto_expansion', '../models/prompt_expansion/proto_expansion')
...
default_temp_path = os.path.join(tempfile.gettempdir(), 'proto')
...
default_metadata_scheme = get_config_item_or_set_default(
    ...
    default_value=MetadataScheme.PROTO.value,
