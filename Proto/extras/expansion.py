...
from modules.config import path_proto_expansion
...
class FooocusExpansion:
    def __init__(self):
        self.tokenizer = AutoTokenizer.from_pretrained(path_proto_expansion)

        positive_words = open(os.path.join(path_proto_expansion, 'positive.txt'),
        ...
        self.model = AutoModelForCausalLM.from_pretrained(path_proto_expansion)
        self.model.eval()
